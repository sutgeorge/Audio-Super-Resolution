...
nrmse_high_res_super_res = normalised_root_mean_squared_error_for_single_examples(high_res_chunk, super_res_chunk, "sd").numpy()
nrmse_high_res_interpolated = normalised_root_mean_squared_error_for_single_examples(high_res_chunk, interpolated_chunk, "sd").numpy()
...
nrmse_parts_of_the_chunk_high_res_super_res = normalised_root_mean_squared_error_for_single_examples(part_of_the_high_res_chunk, part_of_the_super_res_chunk, "sd")
nrmse_parts_of_the_chunk_high_res_interpolated = normalised_root_mean_squared_error_for_single_examples(part_of_the_high_res_chunk, part_of_the_interpolated_chunk, "sd")
figure.tight_layout()
